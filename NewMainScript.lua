...
local function downloadFile(path, func)
	if not isfile(path) then
		local suc, res = pcall(function()
			return game:HttpGet('https://raw.githubusercontent.com/endmylifehahahahahahahahaha/AtomWareV3/'..readfile('newvape/profiles/commit.txt')..'/'..select(1, path:gsub('newvape/', '')), true)
		end)
...
local function downloadPremadeProfiles(commit)
    ...
    local success, response = pcall(function()
        return game:HttpGet('https://api.github.com/repos/endmylifehahahahahahahahaha/AtomWareV3/contents/profiles/premade?ref=' .. commit)
    end)
...
if not shared.VapeDeveloper then
	local _, subbed = pcall(function()
		return game:HttpGet('https://github.com/endmylifehahahahahahahahaha/AtomWareV3')
	end)

	local commit = 'main'
	local ok, res = pcall(function()
		return game:HttpGet('https://api.github.com/repos/endmylifehahahahahahahahaha/AtomWareV3/commits/main', true)
	end)
...
-- Pull main.lua from your fork, everything else from original repo
local mainSrc = game:HttpGet('https://raw.githubusercontent.com/endmylifehahahahahahahahaha/AtomWareV3/main/main.lua', true)
if not mainSrc or mainSrc == '404: Not Found' or mainSrc == '' then
    -- fallback to original if your repo is unavailable
    mainSrc = downloadFile('newvape/main.lua')
else
